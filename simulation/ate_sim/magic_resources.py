...
class MagicAspiration:
 drive:float;desired_base_essences:int;desired_abilities:int;reason:str;formed_year:int;preparation:float=0.;search_years:int=0;completion_goal:bool=False;urgency:float=.0;compromise_tolerance:float=.5;stone_selectiveness:float=.5;risk_tolerance:float=.5;adventurer_aspiration:bool=False;cadet_class_year:int|None=None;cadet_branch:int|None=None;cadet_graduated_year:int|None=None
@dataclass
class MagicResource:
