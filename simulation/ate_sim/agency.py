...
class AgencyState:
    ...
    def assess(self,world,p,attachment:float|None=None,dependents:int|None=None):
...
def agency_step(world,rng):
    attachments={}
    for r in world.social.edges.values():
        attachments[r.a]=max(attachments.get(r.a,0.),r.attachment);attachments[r.b]=max(attachments.get(r.b,0.),r.attachment)
    dependents={}
