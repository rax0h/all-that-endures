"""Pre-index agency control flow with the same calibrated annual earnings."""
from simulation.ate_sim.agency import ActionRecord, _practice_path, ANNUAL_WORK_INCOME
